...
Write-Host "Starting Remediation for STIG ID: WN11-SO-000120" -ForegroundColor Cyan
Write-Host "Goal: Enforce SMB Server Packet Signing (Anti-Spoofing)" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
