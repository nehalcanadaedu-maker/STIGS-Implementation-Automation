...
| [**WN11-CC-000326**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000326) | PowerShell Script Block Logging must be enabled | High | Provides visibility into malicious PowerShell activity; essential for detecting "living-off-the-land" techniques. |
| [**WN11-CC-000327**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000327) | PowerShell Transcription must be enabled | High | Creates full transcripts of PowerShell sessions, enhancing forensic capabilities during incident response. |
| [**WN11-CC-000345**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000345) | WinRM service must not use Basic authentication | High | Prevents credential theft by disallowing weak, unencrypted authentication mechanisms used in lateral movement. |
| [**WN11-CC-000350**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000350) | WinRM service must not allow unencrypted traffic | High | Blocks attackers from intercepting or tampering with WinRM remote management sessions. |
| [**WN11-SO-000120**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-SO-000120) | SMB server must always perform SMB packet signing | High | Prevents relay attacks and tampering with SMB traffic. |
| [**WN11-SO-000100**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-SO-000100) | SMB client must always perform SMB packet signing | High | Hardens both sides of SMB communication, reducing spoofing and MITM attack risks. |
...
| [**WN11-CC-000280**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000280) | RDP must always prompt for password | Medium | Ensures credentials must always be entered manually, preventing auto-use by malware. |
| [**WN11-CC-000310**](https://github.com/nehalcanadaedu-maker/STIGS-Implementation-Automation/tree/main/WN11-CC-000310) | Users must be prevented from changing installation options | Medium | Blocks users/malware from modifying installation settings to bypass security controls. |
